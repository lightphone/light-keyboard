...
class NoQwertyLp3KeyboardViewModel<SwipeResult>(
    ...
    initialLayout = NoQwerty.LowerCaseLayout,
    lowerCaseLayout = NoQwerty.LowerCaseLayout,
    upperCaseLayout = NoQwerty.UpperCaseLayout,
    capsLockedLayout = NoQwerty.CapsLockedLayout,
)
